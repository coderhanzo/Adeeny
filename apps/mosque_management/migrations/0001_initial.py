    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('docs', models.FileField(upload_to=apps.mosque_management.models.upload_to)),
                ('audio', models.FileField(upload_to=apps.mosque_management.models.upload_to)),
                ('video', models.FileField(upload_to=apps.mosque_management.models.upload_to)),
                ('created_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('updated_at', models.DateTimeField(auto_now=True, null=True)),
            ],
        ),
