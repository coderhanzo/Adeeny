    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lat', models.FloatField(blank=True, null=True, verbose_name='Latitude')),
                ('long', models.FloatField(blank=True, null=True, verbose_name='Longitude')),
                ('image', models.ImageField(blank=True, null=True, upload_to=apps.mosque_management.models.Mosque.user_directory_path, verbose_name='Mosque Image')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('docs', models.FileField(blank=True, null=True, upload_to=apps.mosque_management.models.Sermon.user_directory_path)),
                ('audio', models.FileField(blank=True, null=True, upload_to=apps.mosque_management.models.Sermon.user_directory_path)),
                ('video', models.FileField(blank=True, null=True, upload_to=apps.mosque_management.models.Sermon.user_directory_path)),
                ('created_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('updated_at', models.DateTimeField(auto_now=True, null=True)),
            ],
        ),
